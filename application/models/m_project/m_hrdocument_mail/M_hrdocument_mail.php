 ...
 * File Name	= M_hrdocument_mail.php
 * Location		= -
*/

class M_hrdocument_mail extends CI_Model
{
	...
	function get_AllDataC($doc_code, $search) // GOOD
	{
								 	
		$sql = "tbl_hrdoc_header
				WHERE DOCCODE = '$doc_code'
					AND (HRDOCNO LIKE '%$search%' ESCAPE '!' OR HRDOCCODE LIKE '%$search%' ESCAPE '!' 
					OR PRJCODE LIKE '%$search%' ESCAPE '!' OR OWNER_CODE LIKE '%$search%' ESCAPE '!' 
					OR OWNER_DESC LIKE '%$search%' ESCAPE '!' OR HRDOCLOK LIKE '%$search%' ESCAPE '!'
					OR HRDOCJNS LIKE '%$search%' ESCAPE '!' OR HRDOCJNS LIKE '%$search%' ESCAPE '!')";
		return $this->db->count_all($sql);
	}
	
	function get_AllDataL($doc_code, $search, $length, $start, $order, $dir) // GOOD
	{
		if($length == -1)
		{
			if($order !=null)
			{
				$sql = "SELECT * FROM tbl_hrdoc_header
						WHERE DOCCODE = '$doc_code'
							...
							OR PRJCODE LIKE '%$search%' ESCAPE '!' OR OWNER_CODE LIKE '%$search%' ESCAPE '!' 
							OR OWNER_DESC LIKE '%$search%' ESCAPE '!' OR HRDOCLOK LIKE '%$search%' ESCAPE '!'
							OR HRDOC_NOTE LIKE '%$search%' ESCAPE '!' OR HRDOCJNS LIKE '%$search%' ESCAPE '!') ORDER BY $order $dir";
			}
			else
			{
				$sql = "SELECT * FROM tbl_hrdoc_header
						WHERE DOCCODE = '$doc_code'
							...
							OR PRJCODE LIKE '%$search%' ESCAPE '!' OR OWNER_CODE LIKE '%$search%' ESCAPE '!' 
							OR OWNER_DESC LIKE '%$search%' ESCAPE '!' OR HRDOCLOK LIKE '%$search%' ESCAPE '!'
							OR HRDOC_NOTE LIKE '%$search%' ESCAPE '!' OR HRDOCJNS LIKE '%$search%' ESCAPE '!')";
			}
			return $this->db->query($sql);
		}
		else
			...
			if($order !=null)
			{
				$sql = "SELECT * FROM tbl_hrdoc_header
						WHERE DOCCODE = '$doc_code'
							...
							OR PRJCODE LIKE '%$search%' ESCAPE '!' OR OWNER_CODE LIKE '%$search%' ESCAPE '!' 
							OR OWNER_DESC LIKE '%$search%' ESCAPE '!' OR HRDOCLOK LIKE '%$search%' ESCAPE '!'
							OR HRDOC_NOTE LIKE '%$search%' ESCAPE '!' OR HRDOCJNS LIKE '%$search%' ESCAPE '!') ORDER BY $order $dir LIMIT $start, $length";
			}
			else
			{
				$sql = "SELECT * FROM tbl_hrdoc_header
						WHERE DOCCODE = '$doc_code'
							...
							OR PRJCODE LIKE '%$search%' ESCAPE '!' OR OWNER_CODE LIKE '%$search%' ESCAPE '!' 
							OR OWNER_DESC LIKE '%$search%' ESCAPE '!' OR HRDOCLOK LIKE '%$search%' ESCAPE '!'
							OR HRDOC_NOTE LIKE '%$search%' ESCAPE '!' OR HRDOCJNS LIKE '%$search%' ESCAPE '!') LIMIT $start, $length";
			}
			return $this->db->query($sql);
		}
	}
