 ...
 * File Name	= M_listproject.php
 * Location		= -
*/
?>
<?php
class M_listproject extends CI_Model
{
	...
	{
		$sql = "SELECT A.proj_Number, A.PRJCODE, A.PRJCNUM, A.PRJNAME, A.PRJLOCT, A.PRJOWN, A.PRJDATE, A.PRJDATE_CO, A.PRJEDAT, A.PRJDATE_MNT,
