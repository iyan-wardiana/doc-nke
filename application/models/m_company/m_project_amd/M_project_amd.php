...
class M_project_amd extends CI_Model
{
	...
	function updateOTHWBS($paramWBS)
	{
		...
		// 	2. TOTAL BUDGET SETELAH AMANDEMEN
			$NEW_BUDG	= $ITM_REMVAL + $ADD_JOBCOST;

		// 	3. HARGA SETELAH AMANDEMEN
			$NEW_PRICE	= $NEW_BUDG / $ITM_VOLMP;
		
		// 	4. UPDATE MASTER ITEM
			$s_01		= "UPDATE tbl_item SET ADDVOLM = IF(ADDVOLM=0, 1, ADDVOLM), ADDCOST = ADDCOST + $NEW_BUDG
							WHERE PRJCODE = '$PRJCODE' AND ITM_CODE = '$ITM_CODE'";
			$this->db->query($s_01);

		// 	5. UPDATE JOBLIST
			$s_u1		= "UPDATE tbl_joblist_detail SET ADD_VOLM = IF(ADD_VOLM=0, 1, ADD_VOLM), ITM_LASTP = $NEW_PRICE,
								ADD_JOBCOST = ADD_JOBCOST+$ADD_JOBCOST, ADD_PRICE = ADD_JOBCOST / ADD_VOLM
							WHERE JOBCODEID = '$JOBCODEID' AND PRJCODE = '$PRJCODE' AND ITM_CODE = '$ITM_CODE'";
			$this->db->query($s_u1);
			...
			foreach($r_P2 as $rw_P2) :
				$JP2 	= $rw_P2->JOBPARENT;
				$s_u2a	= "UPDATE tbl_joblist SET ADD_VOLM = IF(ADD_VOLM=0, 1, ADD_VOLM), ADD_JOBCOST = ADD_JOBCOST + $ADD_JOBCOST,
								ADD_PRICE = ADD_JOBCOST / ADD_VOLM
							WHERE JOBCODEID = '$JP2' AND PRJCODE = '$PRJCODE'";
				$this->db->query($s_u2a);

				$s_u2b	= "UPDATE tbl_joblist_detail SET ADD_VOLM = IF(ADD_VOLM=0, 1, ADD_VOLM), ITM_LASTP = $NEW_PRICE,
								ADD_JOBCOST = ADD_JOBCOST+$ADD_JOBCOST, ADD_PRICE = ADD_JOBCOST / ADD_VOLM
							WHERE JOBCODEID = '$JP2' AND PRJCODE = '$PRJCODE'";
				$this->db->query($s_u2b);
				// echo "DONE 2<br>";
				...
				foreach($r_P3 as $rw_P3) :
					$JP3 	= $rw_P3->JOBPARENT;
					$s_u3a	= "UPDATE tbl_joblist SET ADD_VOLM = IF(ADD_VOLM=0, 1, ADD_VOLM), ADD_JOBCOST = ADD_JOBCOST + $ADD_JOBCOST,
									ADD_PRICE = ADD_JOBCOST / ADD_VOLM
								WHERE JOBCODEID = '$JP3' AND PRJCODE = '$PRJCODE'";
					$this->db->query($s_u3a);

					$s_u3b	= "UPDATE tbl_joblist_detail SET ADD_VOLM = IF(ADD_VOLM=0, 1, ADD_VOLM), ITM_LASTP = $NEW_PRICE,
									ADD_JOBCOST = ADD_JOBCOST+$ADD_JOBCOST, ADD_PRICE = ADD_JOBCOST / ADD_VOLM
								WHERE JOBCODEID = '$JP3' AND PRJCODE = '$PRJCODE'";
					$this->db->query($s_u3b);
					// echo "DONE 3<br>";
					...
					foreach($r_P4 as $rw_P4) :
						$JP4 	= $rw_P4->JOBPARENT;
						$s_u4a	= "UPDATE tbl_joblist SET ADD_VOLM = IF(ADD_VOLM=0, 1, ADD_VOLM), ADD_JOBCOST = ADD_JOBCOST + $ADD_JOBCOST,
										ADD_PRICE = ADD_JOBCOST / ADD_VOLM
									WHERE JOBCODEID = '$JP4' AND PRJCODE = '$PRJCODE'";
						$this->db->query($s_u4a);

						$s_u4b	= "UPDATE tbl_joblist_detail SET ADD_VOLM = IF(ADD_VOLM=0, 1, ADD_VOLM), ITM_LASTP = $NEW_PRICE,
										ADD_JOBCOST = ADD_JOBCOST+$ADD_JOBCOST, ADD_PRICE = ADD_JOBCOST / ADD_VOLM
									WHERE JOBCODEID = '$JP4' AND PRJCODE = '$PRJCODE'";
						$this->db->query($s_u4b);
						// echo "DONE 4<br>";
						...
						foreach($r_P5 as $rw_P5) :
							$JP5 	= $rw_P5->JOBPARENT;
							$s_u5a	= "UPDATE tbl_joblist SET ADD_VOLM = IF(ADD_VOLM=0, 1, ADD_VOLM), ADD_JOBCOST = ADD_JOBCOST + $ADD_JOBCOST,
											ADD_PRICE = ADD_JOBCOST / ADD_VOLM
										WHERE JOBCODEID = '$JP5' AND PRJCODE = '$PRJCODE'";
							$this->db->query($s_u5a);

							$s_u5b	= "UPDATE tbl_joblist_detail SET ADD_VOLM = IF(ADD_VOLM=0, 1, ADD_VOLM), ITM_LASTP = $NEW_PRICE,
											ADD_JOBCOST = ADD_JOBCOST+$ADD_JOBCOST, ADD_PRICE = ADD_JOBCOST / ADD_VOLM
										WHERE JOBCODEID = '$JP5' AND PRJCODE = '$PRJCODE'";
							$this->db->query($s_u5b);
							// echo "DONE 5<br>";
							...
							foreach($r_P6 as $rw_P6) :
								$JP6 	= $rw_P6->JOBPARENT;
								$s_u6a	= "UPDATE tbl_joblist SET ADD_VOLM = IF(ADD_VOLM=0, 1, ADD_VOLM), ADD_JOBCOST = ADD_JOBCOST + $ADD_JOBCOST,
												ADD_PRICE = ADD_JOBCOST / ADD_VOLM
											WHERE JOBCODEID = '$JP6' AND PRJCODE = '$PRJCODE'";
								$this->db->query($s_u6a);

								$s_u6b	= "UPDATE tbl_joblist_detail SET ADD_VOLM = IF(ADD_VOLM=0, 1, ADD_VOLM), ITM_LASTP = $NEW_PRICE,
												ADD_JOBCOST = ADD_JOBCOST+$ADD_JOBCOST, ADD_PRICE = ADD_JOBCOST / ADD_VOLM
											WHERE JOBCODEID = '$JP6' AND PRJCODE = '$PRJCODE'";
								$this->db->query($s_u6b);
								// echo "DONE 6<br>";
								...
								foreach($r_P7 as $rw_P7) :
									$JP7 	= $rw_P7->JOBPARENT;
									$s_u7a	= "UPDATE tbl_joblist SET ADD_VOLM = IF(ADD_VOLM=0, 1, ADD_VOLM), ADD_JOBCOST = ADD_JOBCOST + $ADD_JOBCOST,
													ADD_PRICE = ADD_JOBCOST / ADD_VOLM
												WHERE JOBCODEID = '$JP7' AND PRJCODE = '$PRJCODE'";
									$this->db->query($s_u7a);

									$s_u7b	= "UPDATE tbl_joblist_detail SET ADD_VOLM = IF(ADD_VOLM=0, 1, ADD_VOLM), ITM_LASTP = $NEW_PRICE,
													ADD_JOBCOST = ADD_JOBCOST+$ADD_JOBCOST, ADD_PRICE = ADD_JOBCOST / ADD_VOLM
												WHERE JOBCODEID = '$JP7' AND PRJCODE = '$PRJCODE'";
									$this->db->query($s_u7b);
									// echo "DONE 7<br>";
									...
									foreach($r_P8 as $rw_P8) :
										$JP8 	= $rw_P8->JOBPARENT;
										$s_u8a	= "UPDATE tbl_joblist SET ADD_VOLM = IF(ADD_VOLM=0, 1, ADD_VOLM), ADD_JOBCOST = ADD_JOBCOST + $ADD_JOBCOST,
														ADD_PRICE = ADD_JOBCOST / ADD_VOLM
													WHERE JOBCODEID = '$JP8' AND PRJCODE = '$PRJCODE'";
										$this->db->query($s_u8a);

										$s_u8b	= "UPDATE tbl_joblist_detail SET ADD_VOLM = IF(ADD_VOLM=0, 1, ADD_VOLM), ITM_LASTP = $NEW_PRICE,
														ADD_JOBCOST = ADD_JOBCOST+$ADD_JOBCOST, ADD_PRICE = ADD_JOBCOST / ADD_VOLM
													WHERE JOBCODEID = '$JP8' AND PRJCODE = '$PRJCODE'";
										$this->db->query($s_u8b);
										// echo "DONE 8<br>";
										...
										foreach($r_P9 as $rw_P9) :
											$JP9 	= $rw_P9->JOBPARENT;
											$s_u9a	= "UPDATE tbl_joblist SET ADD_VOLM = IF(ADD_VOLM=0, 1, ADD_VOLM), ADD_JOBCOST = ADD_JOBCOST + $ADD_JOBCOST,
															ADD_PRICE = ADD_JOBCOST / ADD_VOLM
														WHERE JOBCODEID = '$JP9' AND PRJCODE = '$PRJCODE'";
											$this->db->query($s_u9a);

											$s_u9b	= "UPDATE tbl_joblist_detail SET ADD_VOLM = IF(ADD_VOLM=0, 1, ADD_VOLM), ITM_LASTP = $NEW_PRICE,
															ADD_JOBCOST = ADD_JOBCOST+$ADD_JOBCOST, ADD_PRICE = ADD_JOBCOST / ADD_VOLM
														WHERE JOBCODEID = '$JP9' AND PRJCODE = '$PRJCODE'";
											$this->db->query($s_u9b);
											// echo "DONE 9<br>";
											...
											foreach($r_P10 as $rw_P10) :
												$JP10 	= $rw_P10->JOBPARENT;
												$s_u10a	= "UPDATE tbl_joblist SET ADD_VOLM = IF(ADD_VOLM=0, 1, ADD_VOLM), ADD_JOBCOST = ADD_JOBCOST + $ADD_JOBCOST,
																ADD_PRICE = ADD_JOBCOST / ADD_VOLM
															WHERE JOBCODEID = '$JP10' AND PRJCODE = '$PRJCODE'";
												$this->db->query($s_u10a);

												$s_u10b	= "UPDATE tbl_joblist_detail SET ADD_VOLM = IF(ADD_VOLM=0, 1, ADD_VOLM), ITM_LASTP = $NEW_PRICE,
																ADD_JOBCOST = ADD_JOBCOST+$ADD_JOBCOST, ADD_PRICE = ADD_JOBCOST / ADD_VOLM
															WHERE JOBCODEID = '$JP10' AND PRJCODE = '$PRJCODE'";
												$this->db->query($s_u10b);
												// echo "DONE 10<br>";
	...
	{
		$sql	= 	"tbl_joblist_detail A LEFT JOIN tbl_joblist B ON A.JOBPARENT = B.JOBCODEID AND A.PRJCODE = B.PRJCODE
		...
		if($length == -1)
		{
			if($order !=null)
			{
				$sql = "SELECT A.ITM_CODE, A.ITM_GROUP, A.JOBCODEID, A.JOBDESC, A.JOBPARENT, B.JOBDESC AS JOBPARDESC, A.ITM_UNIT, A.ITM_VOLM, A.ITM_PRICE, A.ITM_BUDG,
						...
						FROM tbl_joblist_detail A LEFT JOIN tbl_joblist B ON A.JOBPARENT = B.JOBCODEID AND A.PRJCODE = B.PRJCODE
						WHERE A.PRJCODE = '$PRJCODE' AND A.ITM_CODE != ''
							AND (A.ITM_CODE LIKE '%$search%' ESCAPE '!' OR A.ITM_UNIT LIKE '%$search%' ESCAPE '!'
