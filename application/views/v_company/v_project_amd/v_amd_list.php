        ...
        <section class="content">
		    <div class="box">
				...
				<div class="box-body">
		            <div class="search-table-outter">
		                <table id="example" class="table table-bordered table-striped table-responsive search-table inner" width="100%">
		                    ...
		                    <tr>
		                        ...
		                        <th style="text-align:center" width="20%"><?php echo $Description; ?> </th>
		                        <th style="text-align:center" width="45%"><?php echo $Notes; ?> </th>
		            ...
		            <br>
                    <?php
						$url_add = site_url('c_comprof/c_am1h0db2/i180dahdd/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
...
<script>
    ...
    $('#example').DataTable( {
		...
		"autoWidth": true,
		"filter": true,
        "ajax": "<?php echo site_url('c_comprof/c_am1h0db2/get_AllData/?id='.$PRJCODE)?>",
        "type": "POST",
		//"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
		"lengthMenu": [[10, 25, 50, 100, 200], [10, 25, 50, 100, 200]],
		"columnDefs": [	{ targets: [0,1,2,5], className: 'dt-body-center' },
