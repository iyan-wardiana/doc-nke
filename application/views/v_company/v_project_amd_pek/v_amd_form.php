							...
							<div class="box-body">
		                        ...
		                        <div class="form-group">
		                          	...
		                          	<div class="col-sm-4" style="display: none;">
                                        <select name="AMD_FUNC1" id="AMD_FUNC1" class="form-control select2" onChange="selFUNC(this.value)" <?php if($AMD_CATEG == 'OB' || $AMD_STAT == 'NB') { ?> disabled <?php } ?>>
                                            <option value=""> --- </option>
		                          	...
		                          	<div class="col-sm-9">
		                                <div class="input-group">
		                                    <div class="input-group-btn">
												<button type="button" class="btn btn-primary" name="btnSelJID" id="btnSelJID" <?php if($AMD_STAT != 1 && $AMD_STAT != 4) { ?> disabled <?php } else { ?> onClick="selJOB()" <?php } ?>><i class="fa fa-search"></i></button>
		                                    </div>
		                                    <input type="hidden" class="form-control" name="JOBCODEID" id="JOBCODEID" value="<?php echo $JOBCODEID; ?>" >
		                                    <input type="text" class="form-control" name="JOBCODEID1" id="JOBCODEID1" value="<?php echo "$JOBCODEID $JOBDESC"; ?>">
		                                    <input type="hidden" class="form-control" name="JOBCODEID2" id="JOBCODEID2" value="<?php echo $JOBCODEID; ?>" data-toggle="modal" data-target="#mdl_addJList">
		                                </div>
		                            </div>
		                        </div>
								<?php
	                            ...
	                            <!-- <div class="form-group" <?php if($AMD_CATEG != 'SI' && $AMD_CATEG != 'SINJ') { ?> style="display: none;"> <?php } ?> -->
	                            <div class="form-group" style="display: none;">
							...
							<div class="box-body">
		                        ...
		                        <div class="form-group">
		                       	  <label for="inputName" class="col-sm-3 control-label"><?php echo $Notes; ?></label>
		                          	<div class="col-sm-9">
		                                <textarea class="form-control" name="AMD_NOTES"  id="AMD_NOTES" style="height:82px"><?php echo $AMD_NOTES; ?></textarea>
		                          	</div>
		                        </div>
		                        <div id="revMemo" class="form-group" <?php if($AMD_MEMO == '') { ?> style="display:none" <?php } ?>>
		                          	...
		                          	<div class="col-sm-9">
		                                <textarea class="form-control" name="AMD_MEMO"  id="AMD_MEMO" style="height:50px" disabled><?php echo $AMD_MEMO; ?></textarea>
		                          	</div>
		                        </div>
		                        <div class="form-group">
				                    ...
				                    <div class="col-sm-3">
				                        <div class="pull-right">
				                        	<a class="btn btn-sm btn-warning" onClick="selITM()" id="btnModal" style="display: none;">
		                        ...
		                        <script>
									...
									function selITM()
									{
								    	...
								    	$('#example1').DataTable(
								    	{
											...
											"autoWidth": true,
											"filter": true,
									        "ajax": "<?php echo site_url('c_comprof/c_am1h0db2/get_AllDataITM_pek/?id=')?>"+collID,
									        "type": "POST",
											//"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
											"lengthMenu": [[10, 25, 50, 100, 200], [10, 25, 50, 100, 200]],
											"columnDefs": [	{ targets: [0], className: 'dt-body-center' },
	                        ...
	                        <div class="search-table-outter">
	                            <table id="tbl" class="table table-bordered table-striped" width="100%">
                                    <tr style="background:#CCCCCC">
										<th width="3%" height="25" rowspan="2" style="text-align:center; vertical-align: middle;">No.</th>
										<th width="15%" rowspan="2" style="text-align:center; vertical-align: middle;">
											<div id="itmName">
												<?php if($AMD_CATEG == 'NB') { echo "Kode Pekerjaan"; } else { echo $ItemCode; } ?>
											</div>
										</th>
										<th width="25%" rowspan="2" style="text-align:center; vertical-align: middle;"><?php echo $ItemName ?> </th>
                                    ...
                                    <tr style="background:#CCCCCC">
                                      	<th style="text-align:center;" nowrap><?php echo $BeginPlan ?> </th>
                                      	<th style="text-align:center;" nowrap><?php echo $Used ?> </th>
                                    ...
                                    if($task == 'edit')
                                    {
                                        $sqlDET	= "SELECT DISTINCT A.AMD_NUM, A.JOBCODEID, A.ITM_CODE, A.ITM_UNIT,
														...
														B.ITM_NAME, B.ITM_GROUP, C.ITM_PRICE, C.ITM_VOLM, C.ITM_BUDG, C.REQ_VOLM, C.REQ_AMOUNT,
														C.ITM_USED, C.ITM_USED_AM, C.ITM_STOCK, C.ITM_STOCK_AM
                                        ...
                                        foreach($result as $row) :
                                            ...
                                            $ITM_USED 		= $row->REQ_VOLM;
                                            $ITM_USED_AM	= $row->REQ_AMOUNT;
											...
											$ADDVOL_VW 		= "";
                                            $sqlJL			= "SELECT (REQ_VOLM + ADDM_VOLM) AS TOT_USEDVOL,
																	(REQ_AMOUNT + ADDM_JOBCOST) AS TOT_USEDVAL,
																	(ITM_VOLM + ADD_VOLM - REQ_VOLM - ADDM_VOLM) AS ITM_REMV,
																	(ITM_BUDG + ADD_JOBCOST - REQ_AMOUNT - ADDM_JOBCOST) AS ITM_REMVAL,
																	ADD_VOLM, ADD_JOBCOST
											...
											foreach($resJL as $rowJL):
												$TOT_USEDVOL	= $rowJL->TOT_USEDVOL;
												$TOT_USEDVAL	= $rowJL->TOT_USEDVAL;
												$ITM_REMV		= $rowJL->ITM_REMV;
                                        ...
                                        /*	if ($j==1) {
                                            ...
                                            <td width="3%" style="text-align:left"> <!-- Item Code -->
												<?php if($AMD_CATEG == 'NB') { echo $JOBCODEID; } else { echo $ITM_CODE; } ?>
                                          	...
                                          	<td width="11%" style="text-align:right"><!-- Item Bdget -->
                                            	<?php
                                            		echo number_format($ITM_VOLMVW, 2);
                                            		echo $ADDVOL_VW;
                                            	?>
                                          	...
                                          	<td width="11%" style="text-align:right">
                                            	<?php echo number_format($TOT_USEDVOL, 2); ?>
                                            	<input type="hidden" class="form-control" style="min-width:110px; max-width:300px; text-align:right" name="TOT_USEDQTY<?php echo $currentRow; ?>" id="TOT_USEDQTY<?php echo $currentRow; ?>" value="<?php echo number_format($TOT_USEDVOL, 2); ?>" >
                                                <input type="hidden" name="data[<?php echo $currentRow; ?>][REM_BUDG]" id="data<?php echo $currentRow; ?>REM_BUDG" value="<?php echo $ITM_REMVAL; ?>">
											</td>
                                         	<td width="3%" style="text-align:center" nowrap> <!-- Item Increase -->
                                                <?php
	                                         		...
	                                         		{
	                                         			?>
                                                			<input type="hidden" name="data[<?php echo $currentRow; ?>][AMD_CLASS]" id="data<?php echo $currentRow; ?>AMD_CLASS" value="2">
	                                         		...
	                                         		else
	                                         		{
		                                                ...
		                                                <?php } else { ?>
	                                         				<input type="hidden" name="data[<?php echo $currentRow; ?>][AMD_CLASS]" id="data<?php echo $currentRow; ?>AMD_CLASS" value="<?php echo $AMD_CLASS; ?>">
		                                                	<input type="checkbox" name="data<?php echo $currentRow; ?>AMD_CLASS" id="AMD_CLASS1<?php echo $currentRow; ?>" value="1" onClick="chgRad1(this,<?php echo $currentRow; ?>);" <?php if($AMD_CLASS == 1) { ?> checked <?php } ?> disabled>
		                                                <?php }
		                                            }
	                                            ?>
                                            </td>
                                         	<td width="3%" style="text-align:right;" nowrap>
                                         		...
                                         		{
	                                         		if($AMD_STAT == 1 || $AMD_STAT == 4) { ?>
                                                	<input type="text" name="AMD_VOLM<?php echo $currentRow; ?>" id="AMD_VOLM<?php echo $currentRow; ?>" value="<?php echo number_format($AMD_VOLM, 2); ?>" class="form-control" style="min-width:80px; max-width:100px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="chgPrice(this,<?php echo $currentRow; ?>);" readonly>
	                                                <?php } else { ?>
	                                                	<?php echo number_format($AMD_VOLM, 2); ?>
	                                                	<input type="hidden" name="AMD_VOLM<?php echo $currentRow; ?>" id="AMD_VOLM<?php echo $currentRow; ?>" value="<?php echo number_format($AMD_VOLM, 2); ?>" class="form-control" style="min-width:80px; max-width:100px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="chgPrice(this,<?php echo $currentRow; ?>);" readonly>
	                                                <?php }
                                         		}
                                         		else
                                         		{
                                         	...
                                         	<td width="2%" style="text-align:center">
                                         		...
                                         		{
                                         			?>
                                         				<input type="checkbox" name="data<?php echo $currentRow; ?>AMD_CLASS" id="AMD_CLASS2<?php echo $currentRow; ?>" value="2" onClick="chgRad2(this,<?php echo $currentRow; ?>);" style="display: none;" <?php if($AMD_CLASS == 2) { ?> checked <?php } ?> disabled>
                                         			<?php
                                         		}
                                         		else
                                         		{
                                         	...
                                         	<td width="3%" style="text-align:right">
                                         		...
                                         		if($r_isLS == 1)
                                         		{
	                                                ...
	                                                <?php } else { ?>
	                                                	...
	                                                	<input type="hidden" name="AMD_PRICE<?php echo $currentRow; ?>" id="AMD_PRICE<?php echo $currentRow; ?>" value="<?php echo number_format($AMD_PRICE, 2); ?>" class="form-control" style="min-width:110px; max-width:300px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="chgPrice(this,<?php echo $currentRow; ?>);" <?php if($AMD_CLASS == 2) { ?> readonly <?php } ?> >
	                                                <?php }
                                         		}
                                         		else
                                         		{
                        ...
                        <div class="form-group">
                          	...
                          	<div class="col-sm-9">
	                        	<?php
									...
									$backURL	= site_url('c_comprof/c_am1h0db2/gall1h0db2amd_pek/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
...
<script>
	...
	function add_item(strItem)
	{
		...
		JOBPARENT		= arrItem[19];
		LASTLEV 		= arrItem[20];
		ISLS 			= arrItem[21];

		if(AMD_CATEG == 'NB')
		{
			totADD 			= document.getElementById('totalrow').value;
			NEXTLEV 		= parseFloat(LASTLEV)+parseFloat(totADD)+1;
			NEXTLEVVW 		= NEXTLEV;
			if(NEXTLEV<10)
				NEXTLEVVW 	= '0'+NEXTLEVVW;

			JOBCODEID		= JOBPARENT+'.'+NEXTLEVVW;
		}
		...
		console.log(ITM_BUDGQTY+'-'+AMD_CATEG)
		...
		// Item Used
			objTD = objTR.insertCell(objTR.cells.length);
			objTD.style.textAlign = 'right';
			objTD.innerHTML = '<input type="text" class="form-control" style="min-width:110px; max-width:300px; text-align:right" name="TOT_USEDQTY'+intIndex+'" id="TOT_USEDQTY'+intIndex+'" value="'+TOT_USEDQTY+'" disabled ><input type="hidden" name="data['+intIndex+'][REM_BUDG]" id="data'+intIndex+'REM_BUDG" value="'+REM_BUDG+'">';
		...
		// Item Class
			...
			if(ISLS == 1)
			{
				objTD.innerHTML = '<input type="hidden" name="data['+intIndex+'][AMD_CLASS]" id="data'+intIndex+'AMD_CLASS" value="2"><input type="checkbox" name="data'+intIndex+'AMD_CLASS" id="AMD_CLASS1'+intIndex+'" value="1" onClick="chgRad1(this,'+intIndex+');" disabled>';
			}
			else
			{
		...
		// Item Class
			...
			if(ISLS == 1)
			{
				objTD.innerHTML = '<input type="checkbox" name="data'+intIndex+'AMD_CLASS" id="AMD_CLASS2'+intIndex+'" value="2" onClick="chgRad2(this,'+intIndex+');" checked disabled>';
			}
			else
			{
