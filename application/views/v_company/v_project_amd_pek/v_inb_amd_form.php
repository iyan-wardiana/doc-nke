                                        ...
                                        /*	if ($j==1) {
                                            ...
                                            <td width="3%" style="text-align:left"> <!-- Item Code -->
                                          	...
                                          	<td width="11%" style="text-align:right">
                                            	...
                                            	<input type="hidden" class="form-control" style="min-width:110px; max-width:300px; text-align:right" name="TOT_USEDQTY<?php echo $currentRow; ?>" id="TOT_USEDQTY<?php echo $currentRow; ?>" value="<?php echo number_format($ITM_USED, 2); ?>" >
                                                ...
                                                <?php
	                                         		...
	                                         		else
	                                         		{
	                                         			if($AMD_STAT == 1 || $AMD_STAT == 4) { ?>
		                                                	...
		                                                	<input type="checkbox" name="data<?php echo $currentRow; ?>AMD_CLASS" id="AMD_CLASS1<?php echo $currentRow; ?>" value="1" onClick="chgRad1(this,<?php echo $currentRow; ?>);" <?php if($AMD_CLASS == 0 || $AMD_CLASS == 1) { ?> checked <?php } ?>>
		                                                <?php } else { ?>
	                                         				<input type="hidden" name="data[<?php echo $currentRow; ?>][AMD_CLASS]" id="data<?php echo $currentRow; ?>AMD_CLASS" value="<?php echo $AMD_CLASS; ?>">
		                                                	<input type="checkbox" name="data<?php echo $currentRow; ?>AMD_CLASS" id="AMD_CLASS1<?php echo $currentRow; ?>" value="1" onClick="chgRad1(this,<?php echo $currentRow; ?>);" <?php if($AMD_CLASS == 0 || $AMD_CLASS == 1) { ?> checked <?php } ?> disabled>
		                                                <?php }
		                                            }
	                                            ?>
                                            </td>
                                         	...
                                         	<td width="2%" style="text-align:center">
                                         		...
                                         		{
                                         			?>
                                         				<input type="checkbox" name="data<?php echo $currentRow; ?>AMD_CLASS" id="AMD_CLASS2<?php echo $currentRow; ?>" value="2" onClick="chgRad2(this,<?php echo $currentRow; ?>);" <?php if($AMD_CLASS == 2) { ?> checked <?php } ?> disabled>
                                         			<?php
                                         		}
                                         		else
                                         		{
	                                         		...
	                                         		{
	                                         			?>
	                                                		<input type="checkbox" name="data<?php echo $currentRow; ?>AMD_CLASS" id="AMD_CLASS2<?php echo $currentRow; ?>" value="2" onClick="chgRad2(this,<?php echo $currentRow; ?>);" <?php if($AMD_CLASS == 0 || $AMD_CLASS == 2) { ?> checked <?php } ?>>
	                                                	<?php
	                                                }
	                                                else
	                                                {
	                                                	?>
	                                                		<input type="checkbox" name="data<?php echo $currentRow; ?>AMD_CLASS" id="AMD_CLASS2<?php echo $currentRow; ?>" value="2" onClick="chgRad2(this,<?php echo $currentRow; ?>);" <?php if($AMD_CLASS == 0 || $AMD_CLASS == 2) { ?> checked <?php } ?> disabled>
	                                               		<?php
	                                               	}
                                               	}
                                               	?>
                       	  ...
                       	  <label for="inputName" class="col-sm-3 control-label">&nbsp;</label>
                          	<div class="col-sm-9">
	                        	<?php
									...
									$backURL	= site_url('c_comprof/c_am1h0db2/i1dah80Idx_pek/?id='.$this->url_encryption_helper->encode_url($PRJCODE));
