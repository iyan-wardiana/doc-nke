                    ...
                    <form class="form-horizontal" name="frm" method="post" action="<?php echo $form_action; ?>" enctype="multipart/form-data" onSubmit="return submitForm()">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                              <select name="JOBPARENT" id="JOBPARENT" class="form-control select2" style="width: 100%">
                                    ...
                                    <?php
                                        $s_BOQ    = "SELECT JOBCODEID, JOBDESC FROM tbl_joblist_detail WHERE PRJCODE = '$PRJCODE' ORDER BY ORD_ID";
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" style="text-align:left" name="JOBCODEID" id="JOBCODEID" value="<?=$JOBCODEID?>" />
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="form-control" style="max-width:150px;text-align:right" name="BOQ_VOLM1" id="BOQ_VOLM1" value="<?php echo number_format($BOQ_VOLM, 2); ?>" onKeyPress="return isIntOnlyNew(event);" onBlur="chgVolmBQ(this);" />
                                <input type="hidden" class="form-control" style="max-width:150px;text-align:right" name="BOQ_VOLM" id="BOQ_VOLM" value="<?=$BOQ_VOLM?>" />
                            </div>
                            <div class="col-sm-2">
                                <input type="text" class="form-control" style="max-width:150px;text-align:right" name="BOQ_PRICE1" id="BOQ_PRICE1" value="<?php echo number_format($BOQ_PRICE, 2); ?>" onKeyPress="return isIntOnlyNew(event);" onBlur="chgPrcBQ(this);" />
                        ...
                        <div class="form-group">
                            <label for="inputName" class="col-sm-2 control-label">&nbsp;</label>
                            <div class="col-sm-2">
                                <input type="text" class="form-control" style="max-width:150px;text-align:right" name="ITM_VOLM1" id="ITM_VOLM1" value="<?php echo number_format($ITM_VOLM, 2); ?>" onKeyPress="return isIntOnlyNew(event);" onBlur="chgVolmRAP(this);" />
                                <input type="hidden" class="form-control" style="max-width:150px;text-align:right" name="ITM_VOLM" id="ITM_VOLM" value="<?=$ITM_VOLM?>" />
                            </div>
                            <div class="col-sm-2">
                                <input type="text" class="form-control" style="max-width:150px;text-align:right" name="ITM_PRICE1" id="ITM_PRICE1" value="<?php echo number_format($ITM_PRICE, 2); ?>" onKeyPress="return isIntOnlyNew(event);" onBlur="chgPrcRAP(this);" />
