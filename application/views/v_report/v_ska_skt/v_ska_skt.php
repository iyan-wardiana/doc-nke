...
<?php
	...
	foreach($resTransl as $rowTransl) :
		...
		if($TranslCode == 'SubBidang')$SubBidang = $LangTransl;
          ...
          <table width="100%">
            ...
            <tr id="SUB_BIDANG">
              ...
              <td colspan="2" nowrap>
                    ...
                    <select name="SUB_BIDANG" id="SUB_BIDANG" class="form-control" style="max-width:300px" >
                             ...
                             <?php
                                    ...
                                    $sqlBID 		= "SELECT doc_code,doc_name FROM tbl_document WHERE doc_code != 'D0243' AND doc_code like '%D0243%'";
                                    $resultBID 	= $this->db->query($sqlBID)->result();
									
									foreach($resultBID as $rowBID) :
										$doc_code1 	= $rowBID->doc_code;
										$doc_name1 	= $rowBID->doc_name;
							?>
											<option value="<?php echo $doc_code1; ?>" <?php if($doc_code1 == $doc_code1) { ?>selected <?php } ?>>
												<?php echo "$doc_name1"; ?>
											</option>
							<?php
									 endforeach;
