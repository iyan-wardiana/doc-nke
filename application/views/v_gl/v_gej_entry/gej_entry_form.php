...
if($task == 'add')
{
	...
	$sql 	= "tbl_journalheader WHERE JournalType = 'GEJ' AND YEAR(JournalH_Date) = $JMY AND MONTH(JournalH_Date) = '$JMM'";
                        	...
                        	<div class="search-table-outter">
		                        ...
		                        <!-- <table width="100%" border="1" id="tbl"> -->
		                        	<tr style="background:#CCCCCC">
		                              	...
		                              	<th width="40%" style="text-align:center"><?php echo $Remarks; ?></th>
		                            ...
		                            if($task == 'edit')
		                            {
										...
										foreach($result as $row) :
											...
											$JOBPARENT 			= "";
											$JOBDESCPR      	= "";
							                $sqlJOBPAR      	= "SELECT JOBCODEID AS JOBPARENT, JOBDESC FROM tbl_joblist_detail
							                						WHERE JOBCODEID IN (SELECT A.JOBPARENT FROM tbl_joblist_detail A
