            ...
            <div class="box box-primary">
                ...
                <form name="frm1" method="post" action="<?php echo $form_action; ?>" enctype="multipart/form-data" onSubmit="return checkData();">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <select name="MB_TYPE" id="MB_TYPE" class="form-control" placeholder="&nbsp;&nbsp;&nbsp;Mail Type" style="width: 100%;" onChange="ShowDocSelect(2);">
                                <?php
...
<script>
	function checkData()
	{
		...
		if(MB_SUBJECT == '')
		{
			alert('The Mail\'s Subject can not be empty.');
