...
if($task == 'add')
{
	...
	$MB_TYPE_X		= '';
	$MB_DEPT		= $MB_DEPT1;
	$MB_STATUS		= 3;							// 1. New/Unread, 2. Read, 3. Draft, 4. Junk, 5. Delete => default 
	$DOC_STATUS		= 1;							// 1. New/Unread, 2. Read, 3. Draft, 4. Junk, 5. Delete
}
else
{
	$MB_NO		    = $default['MB_NO'];
...
<script>
	...
	function checkData()
	{
		...
		var ZeroRec	= 0;
		var MB_TO_ID	= document.getElementById('MB_TO_ID').value;
			if(MB_TO_ID != '')
				var ZeroRec	= 1;
		...
		if(ZeroRec == 0)
		{
			...
			document.getElementById('MB_TO_ID').focus();
			return false;
		}
