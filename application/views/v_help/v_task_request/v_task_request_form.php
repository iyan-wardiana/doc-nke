...
if($task == 'add')
{
    ...
    $DocNumber      = "$comp_init.TR-$lastPatternNumb";
	$TASK_CODE		= $DocNumber;
                        ...
                        <div class="box-body chart-responsive">
                        	<form class="form-horizontal" name="news_form" method="post" action="<?php echo $form_action; ?>" enctype="multipart/form-data" onSubmit="return validateData()">
                                <div class="form-group">
                                    ...
                                    <label for="inputEmail" class="col-sm-1 control-label">Menu</label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="TASK_AUTHOR[]" id="TASK_AUTHOR" class="form-control select2" multiple="multiple" data-placeholder="&nbsp;&nbsp;&nbsp;Pilih Konsultan / Teman" style="width: 100%;">
        									<?php
