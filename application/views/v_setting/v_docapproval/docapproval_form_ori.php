...
<html>
	...
	<?php
		...
		$sqlGetEMPN		= "SELECT Emp_ID, First_Name, Last_Name FROM tbl_employee WHERE FlagAppCheck = 1";
		                                    	...
		                                    	<select name="APPROVER_1" id="APPROVER_1" class="form-control select2" onChange="getChange(1)" <?php if($task == 'add') { ?> disabled <?php } ?>>
						                            ...
						                            <?php
														foreach($resGetEMPN as $rowEMPN) :
															...
															?>
																<option value="<?php echo $Emp_ID1;?>" <?php if($APPROVER_1 == $Emp_ID1) { ?>selected<?php } ?>><?php echo $compName1;?></option>
															<?php
														endforeach;
						                            ?>
						                        </select>
		                                    	...
		                                    	<select name="APPROVER_4" id="APPROVER_4" class="form-control select2" onChange="getChange(4)" <?php if($task == 'add') { ?> disabled <?php } ?>>
						                            ...
						                            <?php
														foreach($resGetEMPN as $rowEMPN) :
															...
															?>
																<option value="<?php echo $Emp_ID4;?>"><?php echo $compName4;?></option>
															<?php
														endforeach;
						                            ?>
						                        </select>
