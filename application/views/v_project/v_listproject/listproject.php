...
<html>
    ...
    <body class="<?php echo $appBody; ?>" style="background-color: <?=$comp_color?>">
        <section class="content-header">
            <h1>
            <img src="<?php echo base_url() . 'assets/AdminLTE-2.0.5/dist/img/icon/project.png'; ?>" style="max-width:40px; max-height:40px" >&nbsp;&nbsp;<?php echo $h1_title; ?>
                        ...
                        <table id="example" class="table table-bordered table-striped table-hover table-responsive search-table inner" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th width="27%" style="text-align:center; vertical-align:middle"><?php echo $Description ?> </th>
                                    <th width="35%" style="text-align:center; vertical-align:middle"><?php echo $Remarks ?> </th>
                                    <th width="4%" style="text-align:center; vertical-align:middle" nowrap>Status</th>
                                    <th width="30%" style="text-align:center; vertical-align:middle">Progress Budget</th> -->
                                    <th width="5%" style="text-align:center; vertical-align:middle" nowrap><?php echo $Code ?> </th>
                                    <th width="30%" style="text-align:center; vertical-align:middle"><?php echo "$BudName / Periode" ?> </th>
                            ...
                            <?php if($ISCREATE == 1 && $this->session->userdata['nSELP'] == 1) { ?>
                            <!-- <tfoot>
                                <tr>
...
<script>
    ...
    $('#example').DataTable( {
        ...
        "autoWidth": true,
        "filter": true,
        "ajax": "<?php echo site_url('c_project/lst180c2hprj/get_AllDataPRJL/?id='.$secURL)?>",
        "type": "POST",
