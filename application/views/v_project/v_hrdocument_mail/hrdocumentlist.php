				        ...
				        <thead>
				            <tr style="background:#CCCCCC">
				                <th style="text-align:center; vertical-align: middle;" width="8%" nowrap><?php echo $DocNumber ?> </th>
				              	...
				              	<th style="text-align:center; vertical-align: middle;" width="9%" nowrap><?php echo $MailType ?></th>
...
<script>
	...
	$(document).ready(function() {
		$('#example1').DataTable({
			...
			"autoWidth": true,
			"filter": true,
			"ajax": "<?php echo site_url('c_project/hrdocument_mail/get_AllData/?id='.$doc_code)?>",
			"type": "POST",
