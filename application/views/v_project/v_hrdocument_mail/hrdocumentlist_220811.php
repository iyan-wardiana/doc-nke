	...
	<table id="example1" class="table table-bordered table-striped" width="100%">
        ...
        <thead>
            <tr style="background:#CCCCCC">
                <th style="text-align:center" width="8%" nowrap><?php echo $DocNumber ?> </th>
              	...
              	<th style="text-align:center;" width="9%" nowrap><?php echo $MailType ?></th>
		...
		<?php
			...
			{	
				foreach($viewdocument as $row) :
					...
					$secURLPI		= site_url('c_project/hrdocument_mail/update/?id='.$this->url_encryption_helper->encode_url($HRDOCNO));
                	?>   	
						<tr>
                            <td nowrap> <?php echo anchor("$secURLPI",$HRDOCNO,array('class' => 'update')).' '; ?> </td>
                            <td nowrap> <?php echo $HRDOCCODE; ?> </td>
                            <td><?php echo $HRDOCJNS; ?></td>
        ...
        <tr>
            ...
            <?php
				if($DAU_WRITE == 1)
				{
					$secAddURL	= site_url('c_project/hrdocument_mail/add/?id='.$this->url_encryption_helper->encode_url($appName));
