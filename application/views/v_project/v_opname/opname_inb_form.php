                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group date">
                                        <div class="input-group-addon">
                                        <i class="fa fa-calendar" style="display: none;"></i>&nbsp;</div><input type="text" name="OPNH_DATESP" class="form-control pull-left" id="datepicker1" value="<?php echo $OPNH_DATESP; ?>" readonly></div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="OPNH_NOTE" id="OPNH_NOTE" class="form-control" style="height: 60px" readonly><?php echo $OPNH_NOTE; ?></textarea>
                                    </div>
                                </div>
