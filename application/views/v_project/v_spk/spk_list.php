                        ...
                        <div class="box-body">
                            <div class="col-sm-2">
                                ...
                                <select name="WO_CATEG" id="WO_CATEG" class="form-control select2" style="width: 100%" onChange="grpBP(this.value)">
                                    <option value=""> --- </option>
                                    <?php
                                        $s_WOC  = "SELECT VendCat_Code, VendCat_Name FROM tbl_vendcat WHERE VendCat_Code NOT IN ('B','O')";
            ...
            <script type="text/javascript">
                function grpBP()
                {
                    ...
                    $('#example').DataTable( {
                        ...
                        "autoWidth": true,
                        "filter": true,
                        "ajax": "<?php echo site_url('c_project/c_s180d0bpk/get_AllDataWOGRP/?id='.$PRJCODE)?>"+'&SPLC='+SPLC+'&GSTAT='+GSTAT+'&SRC='+SRC,
                        "type": "POST",
                        //"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
                        "lengthMenu": [[10, 25, 50, 100, 200], [10, 25, 50, 100, 200]],
                        "columnDefs": [ { targets: [5,6,7], className: 'dt-body-center' },
