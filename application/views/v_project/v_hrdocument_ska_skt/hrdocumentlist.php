				        ...
				        <thead>
				            <tr style="background:#CCCCCC">
				                <th style="text-align:center" width="8%" nowrap><?php echo $DocNumber ?> </th>
				              	...
				              	<th style="text-align:center" width="6%" nowrap><?php echo $DocLocation ?></th>
...
<script>
	$(document).ready(function() {
		$('#example1').DataTable({
			...
			"autoWidth": true,
			"filter": true,
			"ajax": "<?php echo site_url('c_project/hrdocument_ska_skt/get_AllData/?id='.$doc_code)?>",
			"type": "POST",
			//"lengthMenu": [[10, 25, 50, 100, 200, -1], [10, 25, 50, 100, 200, "All"]],
			"lengthMenu": [[10, 25, 50, 100, 200], [10, 25, 50, 100, 200]],
			"columnDefs": [	{ targets: [0,1,2,3,5,6,7,8], className: 'dt-body-center' },
