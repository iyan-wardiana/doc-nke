            ...
            <table width="100%" border="0" style="size:auto" bgcolor="#FFFFFF">
                <tr>
                    ...
                    <td align="left" nowrap class="style1">
                        <input type="text" name="DocNumber" id="DocNumber" value="<?php echo "$HRDOCNO"; ?>" class="form-control" style="max-width:150px" disabled>
                        <input type="hidden" name="Patt_Number" id="Patt_Number" value="<?php echo $lastPatternNumb1; ?>" class="form-control">
                        <input type="hidden" name="PATTCODE" id="PATTCODE" value="<?php echo $Pattern_Code; ?>" class="form-control">
                ...
                <?php
                    ...
                    {	
						?>
							<input type="text" class="form-control" name="HRD_EMPID" id="HRD_EMPID" style="max-width:160px" value="">
                    	<?php
                    }
				?>
                <tr>
