    ...
    <section class="content-header">
        <h1>
            ...
            <?php 
            	if($DAU_WRITE == 1)
				{
					$secAddURL	= site_url('c_project/hrdocument_ska_skt/add/?id='.$this->url_encryption_helper->encode_url($doc_code));
						...
						<?php
							...
							{	
								foreach($viewdocument as $row) :
									...
									$secURLPI		= site_url('c_project/hrdocument_ska_skt/update/?id='.$this->url_encryption_helper->encode_url($HRDOCNO));
				                	?>   	
										<tr>
				                            ...
				                            <td style="text-align:center" nowrap>
				                                <?php
				                                    if($HRDOC_NAME == '')
				                                    {
														$secUplURL		= site_url('c_project/hrdocument_ska_skt/hrdocproject_upload/?id='.$this->url_encryption_helper->encode_url($HRDOCNO));
				                                        ?>
