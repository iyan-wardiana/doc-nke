 ...
 * File Name	= v_weekly_prog_ekst_form.php
 * Location		= -
*/
...
$PRJP_TOT_EKS	= $default['PRJP_TOT_EKS'];
$PRJP_GTOT_EKS	= $default['PRJP_GTOT_EKS'];
$PRJP_STAT		= $default['PRJP_STAT'];
$PRJP_STAT_EKS	= $default['PRJP_STAT_EKS'];
		                      	...
		                      	<div class="form-group">
									...
									<div class="col-sm-3">
										<div class="input-group date">
											...
											<input type="text" name="PRJP_DATE_S" class="form-control pull-left" id="datepicker2" value="<?php echo $Prg_Date1; ?>" style="width:100px" >
										</div>
									</div>
		                            <div class="col-sm-2">
		                            ...
		                            <div class="col-sm-3">
		                              	<div class="input-group date">
		                                  	<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
		                                  	<input type="text" name="PRJP_DATE_E" class="form-control pull-left" id="datepicker3" value="<?php echo $Prg_Date2; ?>" style="width:100px" >
		                                </div>
		                            </div>
		                        </div>
				            	<div class="form-group" style="display: none;">
						...
						<div class="box box-warning">
							...
							<div class="box-body">
				                <?php
									...
									$PRJP_TOTBEF		= 0;
									$PRJP_TOTBEF_EKS	= 0;
									$sqlTOTBEF		= "SELECT SUM(PRJP_TOT) AS PRJP_TOT, SUM(PRJP_TOT_EKS) AS PRJP_TOT_EKS FROM tbl_project_progress
														WHERE PRJCODE = '$PRJCODE' AND PRJP_STEP < $STEP_CURR";
									$resTOTBEF		= $this->db->query($sqlTOTBEF)->result();		
									foreach($resTOTBEF as $rowTOTBEF) :
										$PRJP_TOTBEF 	= $rowTOTBEF->PRJP_TOT;
										$PRJP_TOTBEF_EKS= $rowTOTBEF->PRJP_TOT_EKS;
									endforeach;
									
									$PRJP_GTOT		= $PRJP_TOTBEF + $PRJP_TOT;
									$PRJP_GTOT_EKS	= $PRJP_TOTBEF_EKS + $PRJP_TOT_EKS;
								?>
				            	<div class="form-group">
				                    ...
				                    <div class="col-sm-3">
				                    	...
				                    	<input type="hidden" class="form-control" style="text-align:right" name="PRJP_TOTBEF_EKSX" id="PRJP_TOTBEF_EKSX" value="<?php echo number_format($PRJP_TOTBEF_EKS, 4); ?>" disabled />
				                    </div>
				                    <div class="col-sm-3">
				                    ...
				                    <div class="col-sm-3">
				                        ...
				                        <input type="hidden" class="form-control" style="max-width:180px;text-align:left" name="PRJP_TOT_EKS" id="PRJP_TOT_EKS" size="30" value="<?php echo $PRJP_TOT_EKS; ?>" />
				                    </div>
				                </div>
				            	<div class="form-group">
				                    ...
				                    <div class="col-sm-3">
				                        ...
				                        <input type="hidden" class="form-control" style="max-width:180px;text-align:left" name="PRJP_GTOT_EKS" id="PRJP_GTOT_EKS" size="30" value="<?php echo $PRJP_GTOT_EKS; ?>" />
				                    </div>
				                    <?php
				            	...
				            	<div class="form-group">
				                    ...
				                    <div class="col-sm-9">
				                    	<input type="hidden" name="STAT_BEFORE" id="STAT_BEFORE" value="<?php echo $PRJP_STAT_EKS; ?>">
										<?php
											// START : FOR ALL APPROVAL FUNCTION
												...
												if($ISAPPROVE == 1)
												{
													if($PRJP_STAT_EKS == 1 || $PRJP_STAT_EKS == 2 || $PRJP_STAT_EKS == 7)
													{
														$disButton	= 0;
														if($canApprove == 0)
															$disButton	= 1;													
														?>
															<select name="PRJP_STAT_EKS" id="PRJP_STAT_EKS" class="form-control select2">
																<option value="1"<?php if($PRJP_STAT_EKS == 1) { ?> selected <?php } ?> >New</option>
																<option value="2"<?php if($PRJP_STAT_EKS == 2) { ?> selected <?php } ?> >Confirm</option>
																<option value="3"<?php if($PRJP_STAT_EKS == 3) { ?> selected <?php } ?> >Approved</option>
															</select>
														<?php
													}
												}
	                        ...
	                        <div class="search-table-outter">
	                            <table id="tbl" class="table table-bordered table-striped" width="100%">
		                        	<tr style="background:#CCCCCC">
		                              	...
		                              	<th width="5%" style="text-align:center; vertical-align: middle;"><?php echo $JobCode; ?> </th>
		                              	<th width="20%" style="text-align:center; vertical-align: middle;"><?php echo $Description; ?> </th>
		                              	...
		                              	<th width="10%" style="text-align:center; vertical-align: middle;">Progres Ekst.</th>
		                              	<th width="5%" style="text-align:center; vertical-align: middle;">%</th>
		                            ...
		                            <?php					
										if($task == 'edit')
										{
											...
											$sqlDET		= "SELECT A.JOBCODEID, A.JOBDESC, A.ITM_VOLM AS PROG_BUDG, A.ITM_BUDG AS BOQ_JOBCOST,
																B.PROG_VAL, B.PROG_PERC, B.PROG_VAL_EKS, B.PROG_PERC_EKS, A.BOQ_BOBOT, A.ITM_UNIT, B.PROG_DESC
															FROM tbl_joblist_detail A
																LEFT JOIN tbl_project_progress_det B ON A.JOBCODEID = B.JOBCODEID
																	AND B.PRJP_NUM = '$PRJP_NUM' 
															WHERE 
																A.PRJCODE = '$PRJCODE' AND A.BOQ_BOBOT > 0 AND ISLASTH = 1
															ORDER BY A.JOBCODEID ASC";
										}
										...
										foreach($result as $row) :
											...
											$PROG_VAL_EKS 	= $row->PROG_VAL_EKS;
											$PROG_PERC_EKS 	= $row->PROG_PERC_EKS;
											$BOQ_BOBOT 		= $row->BOQ_BOBOT;
											$JOBUNIT 		= $row->ITM_UNIT;
											...
											// CURRENT PROGRESS
												...
												$PROG_PERC_EKS	= $PROG_VAL_EKS / $PROG_BUDGD * $BOQ_BOBOT;
											...
											<td nowrap style="text-align:center">
		                                    	<input type="text" name="PROG_VAL<?php echo $currentRow; ?>" id="PROG_VAL<?php echo $currentRow; ?>" value="<?php echo number_format($PROG_VAL, 2); ?>" class="form-control" style="min-width:110px; max-width:300px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="getConvertion(this,<?php echo $currentRow; ?>);" readonly >
											...
											<td nowrap style="text-align:center">
		                                    	<input type="text" name="PROG_VAL_EKS<?php echo $currentRow; ?>" id="PROG_VAL_EKS<?php echo $currentRow; ?>" value="<?php echo number_format($PROG_VAL_EKS, 2); ?>" class="form-control" style="min-width:110px; max-width:300px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="getConvertion_ekst(this,<?php echo $currentRow; ?>);">
		                                        <input type="hidden" name="data[<?php echo $currentRow; ?>][PROG_VAL_EKS]" id="data<?php echo $currentRow; ?>PROG_VAL_EKS" value="<?php echo $PROG_VAL_EKS; ?>" class="form-control" style="max-width:300px;" >
		                                    </td>
											<td nowrap style="text-align:center">
		                                    	<input type="text" name="PROG_PERC_EKS<?php echo $currentRow; ?>" id="PROG_PERC_EKS<?php echo $currentRow; ?>" value="<?php echo number_format($PROG_PERC_EKS, 4); ?>" class="form-control" style="min-width:80px; max-width:80px; text-align:right" onKeyPress="return isIntOnlyNew(event);" onBlur="getConvertion(this,<?php echo $currentRow; ?>);" size="10" readonly >
		                                        <input type="hidden" name="data[<?php echo $currentRow; ?>][PROG_PERC_EKS]" id="data<?php echo $currentRow; ?>PROG_PERC_EKS" value="<?php echo $PROG_PERC_EKS; ?>" class="form-control" style="max-width:300px;" >
		                                    </td>
										  	<td style="text-align:left">
		                                    	<input type="text" name="data[<?php echo $currentRow; ?>][PROG_DESC]" id="data<?php echo $currentRow; ?>PROG_DESC" size="20" value="<?php echo $PROG_DESC; ?>" class="form-control" style="min-width:110px; max-width:600px; text-align:left" placeholder="<?php echo $Remarks; ?>">
		                                    </td>
							          	</tr>
		                              	<?php
		                             	endforeach;
...
<script>
	...
	function getConvertion_ekst(thisVal1, row)
	{
		var decFormat	= document.getElementById('decFormat').value;
		totrow			= document.getElementById('totalrow').value;
		...
		PROG_VAL_EKS 	= parseFloat(eval(thisVal1).value.split(",").join(""));

		PROG_BUDG		= parseFloat(document.getElementById('data'+row+'PROG_BUDG').value);
		
		document.getElementById('data'+row+'PROG_VAL_EKS').value 	= PROG_VAL_EKS;
		document.getElementById('PROG_VAL_EKS'+row).value			= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PROG_VAL_EKS)), 4));
		
		PROG_PERC_EKS	= parseFloat(PROG_VAL_EKS) / parseFloat(PROG_BUDG) * parseFloat(BOQ_BOBOT);
		
		document.getElementById('data'+row+'PROG_PERC_EKS').value 	= PROG_PERC_EKS;
		document.getElementById('PROG_PERC_EKS'+row).value			= doDecimalFormat(RoundNDecimal(parseFloat(Math.abs(PROG_PERC_EKS)), 4));
		
		PRJP_TOT_EKS	= 0;
		PRJP_GTOT_EKS	= 0;
		for(i=1;i<=totrow;i++)
		{
			var PROG_PERC_EKS	= document.getElementById('data'+i+'PROG_PERC_EKS').value;
			var PROG_VAL_EKS	= document.getElementById('data'+i+'PROG_VAL_EKS').value;				
			PRJP_TOT_EKS		= parseFloat(PRJP_TOT_EKS) + parseFloat(PROG_PERC_EKS);
		}
		
		var PRJP_TOTBEF_EKS		= parseFloat(eval(PRJP_TOTBEF_EKSX).value.split(",").join(""));
		var PRJP_GTOT_EKS		= parseFloat(PRJP_TOTBEF_EKS) + parseFloat(PRJP_TOT_EKS);
		document.getElementById('PRJP_TOT_EKS').value			= PRJP_TOT_EKS;
		document.getElementById('PRJP_GTOT_EKS').value			= PRJP_GTOT_EKS;
	}
