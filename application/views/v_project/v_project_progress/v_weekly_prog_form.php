	                        ...
	                        <div class="search-table-outter">
	                            <table id="tbl" class="table table-bordered table-striped" width="100%">
		                        	<tr style="background:#CCCCCC">
		                              	...
		                              	<th width="8%" style="text-align:center; vertical-align: middle;">%</th>
		                            ...
		                            <?php					
										if($task == 'edit')
										{
											...
											$sqlDET		= "SELECT A.JOBCODEID, A.JOBDESC, A.ITM_VOLM AS PROG_BUDG, A.ITM_BUDG AS BOQ_JOBCOST,
																B.PROG_VAL, B.PROG_PERC, A.BOQ_BOBOT, A.ITM_UNIT, B.PROG_DESC
										...
										else
										{
											...
											$sqlDET			= "SELECT DISTINCT JOBCODEID, JOBDESC, ITM_VOLM AS PROG_BUDG, ITM_BUDG AS BOQ_JOBCOST,
																	0 AS PROG_VAL, 0 AS PROG_PERC, BOQ_BOBOT, ITM_UNIT, '' AS PROG_DESC
																FROM tbl_joblist_detail
																WHERE PRJCODE = '$PRJCODE' AND BOQ_BOBOT > 0 AND ISLASTH = 1";
										}
