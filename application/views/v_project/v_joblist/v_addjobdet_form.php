...
$TOT_JOBCD 	= 0;
$s_JD		= "SELECT SUM(ITM_BUDG) AS TOT_JOBCD FROM tbl_joblist_detail 
	                ...
	                <div class="col-md-12">
		                <div class="form-group">
		                    ...
		                    <div class="col-sm-9">
		                        ...
		                        <button type="button" class="btn btn-warning" id="btnSync" <?php if($nSyns == 0) { ?> style="display: none;" <?php } ?> title="Sinkronkan" onClick="SyncVal()">
