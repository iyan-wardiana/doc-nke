...
<?php
	...
	foreach($resTransl as $rowTransl) :
		...
		if($TranslCode == 'AssetUsageReport')$AssetUsageReport = $LangTransl;
...
<section class="content">
    ...
    <tr>
        ...
        <td colspan="2" class="style2" style="text-align:center; font-weight:bold; text-transform:uppercase; font-size:12px"><?php echo $AssetUsageReport ?> (Admin)</td>
  </tr>
    <tr>
        ...
        <td colspan="3" class="style2">
            <table width="100%" border="1" rules="all">
                <tr style="background:#CCCCCC">
                  ...
                  <td width="5%" rowspan="2" nowrap style="text-align:center; font-weight:bold"><?php echo $Volume ?></td>
                  <td colspan="7" style="text-align:center; font-weight:bold"><?php echo $Expenses ?></td>
              </tr>
                <tr style="background:#CCCCCC">
                  ...
                  <td width="5%" style="text-align:center; font-weight:bold"><?php echo $Rent ?></td>
                  ...
                  <td width="7%" nowrap style="text-align:center; font-weight:bold"><?php echo $RMFee ?></td>
                ...
                <?php					
                    ...
                    {
						$sqlq0 			= "SELECT A.*, B.JL_NAME, B.JL_DESC FROM tbl_asset_usage A
												INNER JOIN tbl_asset_joblist B ON A.AU_JOBCODE = B.JL_CODE
													AND B.JL_PRJCODE IN ($PRJCODECOL)
											WHERE A.AU_PRJCODE IN ($PRJCODECOL) AND $KONDITT AND AU_PROCS = 2 ORDER BY A.AU_DATE";
                    ...
                    else
                    {
						$sqlq0 			= "SELECT A.*, B.JL_NAME, B.JL_DESC FROM tbl_asset_usage A
												INNER JOIN tbl_asset_joblist B ON A.AU_JOBCODE = B.JL_CODE
													AND B.JL_PRJCODE IN ($PRJCODECOL)
											WHERE $KONDITT AND AU_PROCS = 2 ORDER BY A.AU_DATE";
						$resq0 			= $this->db->query($sqlq0)->result();
                    }
                    ...
                    foreach($resq0 as $rowsqlq0) :
                        ...
                        ?>
                            <tr>
                                ...
                                <td nowrap style="text-align:center;"><?php echo $AU_PROCD; ?></td>
                                <td nowrap style="text-align:left;"><?php echo $AU_DESC; ?></td>
                                <td nowrap style="text-align:right;"><?php echo number_format($AP_QTYOPR, $decFormat); ?></td>
                                <td nowrap style="text-align:right;"><?php echo number_format($ISRENTP, $decFormat); ?></td>
                                ...
                                <td nowrap style="text-align:right;"><?php echo number_format($ISWAGEP, $decFormat); ?></td>
                                <td nowrap style="text-align:right;"><?php echo number_format($AU_TOTAL, $decFormat); ?></td>
                            </tr>
                        <?php
                    endforeach;
                ?>
