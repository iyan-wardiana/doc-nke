...
class _eM  extends CI_Controller
{
	var $limit = 2;
	var $title = 'NKE ITSys';
 	...
 	function index() // U
	{
		...
		$url			= site_url('_eM/efR/?id='.$this->url_encryption_helper->encode_url($appName));
		redirect($url);
	}
	
	function efR($offset=0) // U - index
	{
	...
	function write_mail($offset=0) // U
	{
		...
		if ($this->session->userdata('login') == TRUE)
		{
			...
			$data['task']			= 'add';
			$data['h2_title']		= 'Mailbox';
			$data['form_action']	= site_url('_eM/write_mail_process');
	...
	function write_mail_process() // U
	{
		...
		{		
			...
			if($MB_STATUS == 1)
			{
				$url	= site_url('_eM/sent_mail/?id='.$this->url_encryption_helper->encode_url($DefEmp_ID));
			}
			else
			{
				$url	= site_url('_eM/draft_mail/?id='.$this->url_encryption_helper->encode_url($DefEmp_ID));
			}
			redirect($url);
		}
		else
	...
	{	
		...
		if ($this->session->userdata('login') == TRUE)
		{
			...
			$data['task']			= 'add';
			$data['h2_title']		= 'Mailbox';
			$data['action_reply']	= site_url('_eM/reply_mail/?id='.$this->url_encryption_helper->encode_url($MB_ID));
			$data['action_forward']	= site_url('_eM/forward_mail/?id='.$this->url_encryption_helper->encode_url($MB_ID));
			$data['action_trash']	= site_url('_eM/trash_mail_process/?id='.$this->url_encryption_helper->encode_url($MB_ID));
	...
	{	
		...
		if ($this->session->userdata('login') == TRUE)
		{
			...
			//$data['action_reply']	= site_url('_eM/reply_mail/?id='.$this->url_encryption_helper->encode_url($MB_ID));
			//$data['action_forward']	= site_url('_eM/forward_mail/?id='.$this->url_encryption_helper->encode_url($MB_ID));
			$data['action_trash']	= site_url('_eM/trash_mail_process_idx_S/?id='.$this->url_encryption_helper->encode_url($MB_ID));
	...
	{	
		...
		if ($this->session->userdata('login') == TRUE)
		{
			...
			//$data['action_reply']	= site_url('_eM/reply_mail/?id='.$this->url_encryption_helper->encode_url($MB_ID));
			//$data['action_forward']	= site_url('_eM/forward_mail/?id='.$this->url_encryption_helper->encode_url($MB_ID));
			$data['action_trash']	= site_url('_eM/trash_mail_process_idx_T/?id='.$this->url_encryption_helper->encode_url($MB_ID));
	...
	function reply_mail($offset=0) // U
	{
		...
		if ($this->session->userdata('login') == TRUE)
		{
			...
			$data['task']			= 'add';
			$data['h2_title']		= 'Mailbox';
			$data['form_action']	= site_url('_eM/reply_mail_process');
	...
	function reply_mail_process() // U
	{
		...
		{		
			...
			$url			= site_url('_eM/sent_mail');
			$url			= site_url('_eM/sent_mail/?id='.$this->url_encryption_helper->encode_url($Emp_ID));
			redirect($url);
		}
		else
		{
	...
	function draft_mail_update() // U - index
	{
		...
		if ($this->session->userdata('login') == TRUE)
		{
			...
			$data['task']			= 'edit';
			$data['h2_title']		= 'Mailbox';
			$data['form_action']	= site_url('_eM/draft_mail_update_process');
			$data['action_trash']	= site_url('_eM/trash_mail_process/?id='.$this->url_encryption_helper->encode_url($MB_ID));
	...
	{	
		...
		{		
			...
			$url			= site_url('_eM/?id='.$this->url_encryption_helper->encode_url($Emp_ID));
			redirect($url);
		}
		else
		{
